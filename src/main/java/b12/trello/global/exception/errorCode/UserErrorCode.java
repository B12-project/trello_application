...
public enum UserErrorCode implements ErrorCode {
    ...
    EXPIRED_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED.value(), "리프레시 토큰이 만료되었습니다. 재 로그인이 필요합니다."),
    ...
    PASSWORD_DUPLICATED(HttpStatus.BAD_REQUEST.value(), "현재와 동일한 비밀번호로 변경 할 수 없습니다.");
